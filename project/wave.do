...
add wave -noupdate -expand -group IFID /proc_hier_pbench/DUT/p0/Pipeline_Control/IFID_Rs
add wave -noupdate -expand -group IFID /proc_hier_pbench/DUT/p0/Pipeline_Control/IFID_Rt
...
add wave -noupdate -group Execute -radix decimal /proc_hier_pbench/DUT/p0/executeStage/regData1
add wave -noupdate -group Execute /proc_hier_pbench/DUT/p0/executeStage/regData2
add wave -noupdate -group Execute -radix decimal /proc_hier_pbench/DUT/p0/executeStage/Out
...
add wave -noupdate -group Data_mem /proc_hier_pbench/DUT/p0/memoryStage/data_mem/control/Addr
add wave -noupdate -group Data_mem /proc_hier_pbench/DUT/p0/memoryStage/data_mem/control/DataIn
add wave -noupdate -group Data_mem /proc_hier_pbench/DUT/p0/memoryStage/data_mem/control/Rd
add wave -noupdate -group Data_mem /proc_hier_pbench/DUT/p0/memoryStage/data_mem/control/Wr
add wave -noupdate -group Data_mem /proc_hier_pbench/DUT/p0/memoryStage/data_mem/control/DataOut
add wave -noupdate -group Data_mem /proc_hier_pbench/DUT/p0/memoryStage/data_mem/control/Done
add wave -noupdate -group Data_mem /proc_hier_pbench/DUT/p0/memoryStage/data_mem/control/Stall
add wave -noupdate -group Data_mem /proc_hier_pbench/DUT/p0/memoryStage/data_mem/control/CacheHit
add wave -noupdate -group Data_mem /proc_hier_pbench/DUT/p0/memoryStage/data_mem/control/err
add wave -noupdate -group Data_mem /proc_hier_pbench/DUT/p0/memoryStage/data_mem/control/state
add wave -noupdate -group Data_mem /proc_hier_pbench/DUT/p0/memoryStage/data_mem/control/next_state
add wave -noupdate /proc_hier_pbench/DUT/p0/executeStage/aluOp
add wave -noupdate -radix decimal /proc_hier_pbench/DUT/p0/executeStage/immVal
add wave -noupdate -radix decimal /proc_hier_pbench/DUT/p0/decodeStage/exImmVal
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {7301 ns} 0} {Trace {2035 ns} 0}
...
update
WaveRestoreZoom {2288 ns} {8488 ns}
