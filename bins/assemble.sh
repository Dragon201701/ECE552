...
fullfilename() {
    ...
    if [ -e $1 ]; then
		...
		echo "Full name to pass to Assemble.java: "$FULLNAME
...
java -classpath ~sinclair/courses/cs552/spring2020/handouts/assembler Assemble $FULLNAME $outfile_prefix > $outfile;
